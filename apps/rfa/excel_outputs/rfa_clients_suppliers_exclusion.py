...
def get_row():
    ...
    yield from [
        ...
        for row in ClientSupplierExclusion.objects.all()
        .values(
            "cct__cct",
            "cct__intitule",
            "supplier",
        )
        .order_by("cct__cct", "supplier")
    ]


def excel_list_rfa_clients_suppliers_exclusion(file_io: io.BytesIO, file_name: str) -> dict:
    """Fonction de génération du fichier de liste des Clients/CCT, SUpplier à exclure des RFA"""
