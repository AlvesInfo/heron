...
def write_bispar_sdoa(fcy, file_name=None, nb_fac=5000):
    ...
    rows = get_rows(connection, settings.APPS_DIR, fcy, "sql_export_x3_purchase_sdoa_invoices")
