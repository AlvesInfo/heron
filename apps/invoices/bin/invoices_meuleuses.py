...
"""
Génération des factures de redevance Meuleuse, vers le module edi_import
FR : Module de génération des factures de redevance Meuleuse
EN : Grinder royalty invoice generation module
...
def meuleuse(dte_d: AnyStr, dte_f: AnyStr):
