with "real_purchase" as(
	select
	    ...
	    ('GA00' || "isi"."invoice_number") as "NUM", -- Numéro de pièce
	    'ACAF001' as "BPR", -- Tiers
	    'GAUDF' as "CPY", -- Société
	    'GA00' as "FCY", -- Site
...
select
		"invoice_number",
		"T", "PIVTYP", "NUM", "BPR", "CPY", "FCY", "ACCDAT", "CUR", "CURTYP", "BPRRAY", "STRDUDDAT",
		     "PTE", "VAC", "BPRVCR", "PBPAINV", "BPAPAY", "DES",
		"L", "L_LIG", "L_FCYLIN", "COA_00", "COA_01", "SAC", "ACC_00", "ACC_01", "BPRLIN",
		     "AMTNOTLIN", "QTY_L", "VAT", "DES_L",
		"A", "ANALIG",
		     "DIE", "DIE_01", "DIE_02", "DIE_03", "DIE_04",
		     -- "DIE_05",
		     "CCE", "CCE_01", "CCE_02", "CCE_03", "CCE_04",
		     -- "CCE_05",
		     "AMT", "QTY_A",
		"E", "DUDLIG", "DUDDAT", "PAM", "PAMTYP", "AMTCUR", "BPARAY", test_a
from "real_purchase"
