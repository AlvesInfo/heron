...
from apps.corefunctions.functions_setups import settings
from apps.corefunctions.functions_excel import get_paper_size
...
petit_logo = Path(settings.STATIC_DIR) / "petit_logo.png"
point_vert = Path(settings.IMAGES_DIR) / "point_vert.png"
