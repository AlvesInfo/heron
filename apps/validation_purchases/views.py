...
def integration_supplier_purchases(request, third_party_num, big_category, month):
    ...
    :param month: Mois de facturation
    :return: view
    """
...
def details_purchases(request, third_party_num, invoice_number):
