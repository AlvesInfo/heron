...
l = ["COOPERVISION", "SURDIFUSE", "NEWSON", "STARKEY", "PRODITION", "TEFID", "TECHNIDIS", "BBRG_VERRE", "PHONAK", "INTERSON", "UNITRON", "JOHNSON", "WIDEX", "WIDEX_GA", "LMC", "EYE_CONFORT", "HANSATON", "SIGNIA", "HEARING", "GENERIQUE", "EDI", ]
