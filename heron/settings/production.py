...
# OIDC_AUTHENTICATION_CALLBACK_URL = config("OIDC_AUTHENTICATION_CALLBACK_URL")
#
# OIDC_CREATE_USER = False
# OIDC_RP_SCOPES = "openid scope_1 scope_2"
# OIDC_AUTH_REQUEST_EXTRA_PARAMS = {"acr_values": "eidas2"}
# OIDC_RENEW_ID_TOKEN_EXPIRY_SECONDS = 120
# OIDC_USER_IDENTIFIANT_IN_CLAIMS = "identifier"
#
# AUTHENTICATION_BACKENDS = ("apps.users.oidc_backend.heronOidcuserBackend",)
